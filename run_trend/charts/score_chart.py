...
class ScoreChart(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Create chart
        self.chart = QChart()
        self.chart.setTitle(self.tr("Training Status Score"))
    ...
    def update_chart(self, aggregates: List[Dict[str, Any]], smoothing: str = 'off'):
        ...
        # Extract score data
        scores = [agg.get('training_score', 0) for agg in complete_aggregates]
        ...
        axis_y = QValueAxis()
        axis_y.setTitleText(self.tr("Score (0-100)"))
